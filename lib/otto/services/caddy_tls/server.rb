# lib/otto/services/caddy_tls/server.rb
#
    ...
    module CaddyTLS
      ...
      class Server
        ...
        def enable!(endpoint:, localhost_only:, permission:)
          ...
          @otto.use(Otto::Services::LocalhostGuard, endpoint) if localhost_only
        ...
        def register_route(endpoint)
          route      = Otto::Route.new('GET', endpoint, 'Otto::Services::CaddyTLS::PermissionHandler.handle')
          route.otto = @otto
